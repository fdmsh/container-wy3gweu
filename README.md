...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-wy3gweu.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-wy3gweu.containers.anotherwebservice.com/
...
```
git clone git@github.com:fdmsh/container-wy3gweu.git
cd container-wy3gweu
```
...
```
docker attach container-wy3gweu
```
